...
**状态**：已接受（取代 [ADR-0052](0052-rolling-prerelease-channel.md) 决策 2；其「纯 X.Y.Z 无后缀」与「基线 minor+1」均已被 [ADR-0056](0056-rolling-prerelease-dev-distance-version.md) 取代（改为基线不 +1、`-dev.<提交距离>.g<sha>`）；CI 自算版本号 / 与 VERSION 解耦仍有效）
