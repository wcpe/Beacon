...
**状态**：已被 [ADR-0073](0073-standard-rc-ga-release-lifecycle.md) 部分取代（本 ADR 的滚动 prerelease、stable/prerelease 双渠道及普通 prerelease 消费决策不再有效；正式 GA 作为稳定发布的基本语义保留。其余前序取代关系仅供历史追溯）
