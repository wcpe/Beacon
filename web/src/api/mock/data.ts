...
export const mockInstances: InstanceView[] = [
  { namespace: 'prod', serverId: 'server-01', role: 'bukkit', group: 'server-a', zone: 'zone-01', assigned: true, address: '10.0.0.1:25565', version: '1.20.4', status: 'online', capacity: 100, weight: 1, metadata: {}, lastHeartbeat: ago(5), lastHeartbeatAgeSec: 5, healthReason: '', appliedMd5: 'abc12345', playerCount: 42, tps: 19.8, backends: [], zoneDefaultEntry: true, proxy: ZERO_PROXY, registeredAt: ago(86400) },
  { namespace: 'prod', serverId: 'server-02', role: 'bukkit', group: 'server-a', zone: 'zone-01', assigned: true, address: '10.0.0.2:25565', version: '1.20.4', status: 'online', capacity: 100, weight: 1, metadata: {}, lastHeartbeat: ago(10), lastHeartbeatAgeSec: 10, healthReason: '', appliedMd5: 'abc12345', playerCount: 38, tps: 19.5, backends: [], zoneDefaultEntry: false, proxy: ZERO_PROXY, registeredAt: ago(86400) },
  ...
  { namespace: 'prod', serverId: 'server-04', role: 'bukkit', group: 'server-b', zone: 'zone-02', assigned: true, address: '10.0.0.4:25565', version: '1.20.4', status: 'online', capacity: 100, weight: 1, metadata: {}, lastHeartbeat: ago(3), lastHeartbeatAgeSec: 3, healthReason: '', appliedMd5: 'abc12345', playerCount: 55, tps: 19.2, backends: [], zoneDefaultEntry: true, proxy: ZERO_PROXY, registeredAt: ago(43200) },
  { namespace: 'test', serverId: 'test-01', role: 'bukkit', group: 'server-a', zone: 'zone-01', assigned: true, address: '10.0.1.1:25565', version: '1.20.4', status: 'online', capacity: 50, weight: 1, metadata: {}, lastHeartbeat: ago(8), lastHeartbeatAgeSec: 8, healthReason: '', appliedMd5: 'abc12345', playerCount: 5, tps: 20.0, backends: [], zoneDefaultEntry: false, proxy: ZERO_PROXY, registeredAt: ago(86400) },
]
