...
var resetTables = []string{"config_gray", "config_revision", "config_item", "file_revision", "file_object", "file_override_set_revision", "file_override_set", "reverse_fetch_task", "reverse_fetch_ignore_rule", "agent_command", "zone_assignment", "server_drain", "server_offline", "audit_log", "alert_event", "metric_sample", "api_key", "setting", "namespace"}
