...
// 集成测试涉及的可清空表（按外键无关顺序）。
var resetTables = []string{"config_gray", "config_revision", "config_item", "file_revision", "file_object", "file_override_set_revision", "file_override_set", "zone_assignment", "server_drain", "audit_log", "metric_sample", "namespace"}
