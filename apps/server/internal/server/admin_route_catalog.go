...
var adminRouteCatalog = mergeRouteCatalog(
	...
	route("management.read", auth.CapabilityManagementRead, routeDirect, http.MethodGet,
		...
		"/admin/v1/reverse-fetch/tasks", "/admin/v1/reverse-fetch/tasks/{id}", "/admin/v1/reverse-fetch/tasks/{id}/conflicts", "/admin/v1/reverse-fetch/tasks/{id}/conflicts/diff", "/admin/v1/reverse-fetch/ignore-rules",
	...
	route("approval.request", auth.CapabilityApprovalRequest, routeApprovalRequired, http.MethodPost,
		...
		"/admin/v1/api-keys", "/admin/v1/api-keys/{id}/reset", "/admin/v1/system/update", "/admin/v1/system/rollback", "/admin/v1/configs/batch", "/admin/v1/configs/{id}/rollback", "/admin/v1/configs/{id}/gray", "/admin/v1/configs/{id}/gray/promote", "/admin/v1/files/import", "/admin/v1/files/batch", "/admin/v1/files/{id}/rollback", "/admin/v1/override-sets/{id}/rollback", "/admin/v1/instances/{serverId}/logs", "/admin/v1/instances/{serverId}/resync", "/admin/v1/instances/{serverId}/reverse-fetch", "/admin/v1/reverse-fetch/tasks/{id}/submit", "/admin/v1/reverse-fetch/tasks/{id}/resolve", "/admin/v1/instances/{serverId}/imprint", "/admin/v1/imprints/{commandId}/confirm", "/admin/v1/file-sync/tasks/{id}/start", "/admin/v1/file-sync/tasks/{id}/resume",
