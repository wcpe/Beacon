...
var adminRouteCatalog = mergeRouteCatalog(
	...
	route("management.read", auth.CapabilityManagementRead, routeDirect, http.MethodGet,
		...
		"/admin/v2/namespaces", "/admin/v2/namespaces/{id}/lifecycle-impact", "/admin/v2/namespaces/{id}/permanent-deletion-impact", "/admin/v2/namespace-trusts", "/admin/v2/envs", "/admin/v2/agent-identities", "/admin/v2/agent-identities/{identityId}", "/admin/v2/mcp-clients", "/admin/v2/mcp-clients/{clientId}", "/admin/v2/mcp/config", "/admin/v2/metrics/summary", "/admin/v2/metrics/series", "/admin/v2/health", "/admin/v2/health/snapshots", "/admin/v2/health/{serverId}", "/admin/v2/settings/health-weights", "/admin/v2/zone-tree", "/admin/v1/alert-events/{id}/context", "/admin/v2/servers", "/admin/v2/servers/{id}/lifecycle-impact", "/admin/v2/servers/{id}/permanent-deletion-impact", "/admin/v2/lobby-clusters", "/admin/v2/lobby-clusters/{id}", "/admin/v2/sched-decisions", "/admin/v2/sched-decisions/summary", "/admin/v2/sched-decisions/{traceId}", "/admin/v2/connections", "/admin/v2/connections/stats", "/admin/v2/connections/{connId}", "/admin/v2/messages", "/admin/v2/messages/stats", "/admin/v2/messages/{messageId}", "/admin/v2/archive/overview", "/admin/v2/archive/jobs", "/admin/v2/archive/jobs/{id}", "/admin/v2/config-files/trash", "/admin/v2/config-files", "/admin/v2/config-files/{id}", "/admin/v2/config-files/{id}/scopes", "/admin/v2/config-files/{id}/versions", "/admin/v2/config-files/{id}/effective", "/admin/v2/config-files/{id}/diff", "/admin/v2/config-versions/{versionId}", "/admin/v2/assets", "/admin/v2/assets/scan-status", "/admin/v2/assets/compare", "/admin/v2/assets/sensitive-rules", "/admin/v2/change-orders", "/admin/v2/change-orders/{id}", "/admin/v2/change-orders/{id}/impact", "/admin/v2/change-orders/{id}/targets", "/admin/v2/change-orders/{id}/observe", "/admin/v2/change-orders/{id}/events", "/admin/v2/change-orders/{id}/items/{itemId}/file-diff"),
	...
	route("management.direct", auth.CapabilityManagementDirect, routeDirect, http.MethodPut, "/admin/v1/namespaces/{code}", "/admin/v1/scheduling/drains", "/admin/v2/envs/{id}/namespaces", "/admin/v2/agent-identities/{identityId}/endpoints/{endpointKey}", "/admin/v2/settings/health-weights", "/admin/v2/assets/sensitive-rules", "/admin/v2/servers/{serverId}/tags"),
	route("management.direct", auth.CapabilityManagementDirect, routeDirect, http.MethodDelete, "/admin/v1/reverse-fetch/ignore-rules/{id}", "/admin/v1/configs/{id}/gray", "/admin/v1/instances/{serverId}/offline", "/admin/v2/envs/{id}", "/admin/v2/namespace-trusts/{id}/revoke", "/admin/v2/config-files/{id}/scopes/{scopeLevel}/{scopeRefId}", "/admin/v2/servers/{serverId}/tags/{key}"),
