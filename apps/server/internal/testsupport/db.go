...
var resetTables = []string{"config_gray", "config_revision", "config_item", "file_revision", "file_object", "file_override_set_revision", "file_override_set", "reverse_fetch_task", "reverse_fetch_ignore_rule", "agent_command", "file_sync_log", "file_sync_target", "file_sync_batch", "file_sync_task", "zone_assignment", "server_drain", "server_offline", "audit_log", "alert_event", "metric_sample", "api_key", "setting", "reversible_operation", "agent_identity", "server", "zone", "region", "bc_cluster", "env_namespace", "env", "namespace_trust", "namespace"}
