...
class TabooLibConfigReader(
    ...
    override fun string(
        path: String,
        default: String,
    ): String = config.getString(path, default) ?: default

    override fun int(
        path: String,
        default: Int,
    ): Int = config.getInt(path, default)

    override fun long(
        path: String,
        default: Long,
    ): Long = config.getLong(path, default)

    override fun double(
        path: String,
        default: Double,
    ): Double = config.getDouble(path, default)

    override fun boolean(
        path: String,
        default: Boolean,
    ): Boolean = config.getBoolean(path, default)
